 ...
 *
 * @param ctx    pointer to a buffersink or abuffersink filter m_context.
 ...
 * Get a frame with filtered data from sink and put it in frame.
 *
 * @param ctx pointer to a m_context of a buffersink or abuffersink AVFilter.
 * @param frame pointer to an allocated frame that will be filled with data.
 *              The data must be freed using av_frame_unref() / av_frame_free()
 *
 * @return
 ...
 *
 * @param ctx pointer to a m_context of the abuffersink AVFilter.
 * @param frame pointer to an allocated frame that will be filled with data.
 *              The data must be freed using av_frame_unref() / av_frame_free()
