...
/**
 * Allocate an AVMurMur3 hash m_context.
 *
 * @return Uninitialized hash m_context or `NULL` in case of error
 */
struct AVMurMur3 *av_murmur3_alloc(void);

/**
 * Initialize or reinitialize an AVMurMur3 hash m_context with a seed.
 *
 * @param[out] c    Hash m_context
...
/**
 * Initialize or reinitialize an AVMurMur3 hash m_context.
 *
...
/**
 * Update hash m_context with new data.
 *
 * @param[out] c    Hash m_context
