 ...
 *
 * @note Using a different m_context than the one allocated during av_tx_init()
 * is not allowed.
 *
 * @param s the transform m_context
...
/**
 * Initialize a transform m_context with the given configuration
 * (i)MDCTs with an odd length are currently not supported.
 *
 * @param ctx the m_context to allocate, will be NULL on error
...
/**
 * Frees a m_context and sets *ctx to NULL, does nothing when *ctx == NULL.
 */
