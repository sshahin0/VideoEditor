 ...
 * frames m_context to OpenCL with av_hwframe_ctx_create_derived().
 */
...
typedef struct AVOpenCLDeviceContext {
     ...
     * are associated with the m_context then this is the one which will
     * be used for all operations internal to FFmpeg.
     */
    cl_device_id device_id;
    /**
     * The OpenCL m_context which will contain all operations and frames on
     * this device.
     */
    cl_context context;
    /**
