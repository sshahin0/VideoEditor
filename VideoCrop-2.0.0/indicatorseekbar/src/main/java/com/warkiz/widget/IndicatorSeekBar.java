 ...
 * @file: IndicatorSeekBar.java
 * @modified: Aug 14, 2024, 10:54 AM
 */
...
public class IndicatorSeekBar extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = Math.round(mCustomDrawableMaxHeight + getPaddingTop() + getPaddingBottom()) + SizeUtils.dp2px(mContext, 8);
