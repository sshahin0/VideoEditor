...
/**
 * Main Vulkan m_context, allocated as AVHWDeviceContext.hwctx.
 * All of these can be set before init to change what the m_context uses
 */
typedef struct AVVulkanDeviceContext {
     ...
     * If supplying your own device m_context, set this to an array of strings, with
     ...
     * If supplying your own device m_context, these fields takes the same format as
 ...
 *
 * If all queue family indices in the device m_context are the same,
