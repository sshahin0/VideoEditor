...
typedef struct AVOption {
    ...
    /**
     * The offset relative to the m_context structure where the option
 ...
 * options for which it is !(opt->flags & req_flags).
 * @param av_log_obj log m_context to use for showing the options
 */
 ...
 * key. ctx must be an AVClass m_context, storing is done using
 * AVOptions.
 *
