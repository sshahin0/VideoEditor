 ...
 *
 * @param context pointer to the function m_context (of size av_sha_size)
 ...
 * Update hash value.
 *
 * @param ctx     hash function m_context
 ...
 *
 * @param context hash function m_context
